...
const BonusStripe: FunctionComponent<Props> = ({
  ...
  const visitGuide = () => {
    switch (bonus.name) {
      ...
      case "Unibet Casino":
        window.open(
          "https://www.spikeslot.com/guida/guida-bonus-unibet-casino/it"
        );
        break;

      case "Eurobet Casino":
        window.open(
          "https://www.spikeslot.com/guida/guida-bonus-benvenuto-eurobet/it"
        );
        break;

      case "Betway":
        window.open(
          "https://www.spikeslot.com/guida/bonus-benvenuto-casino-betway/it"
        );
        break;

      case "Casino.com Casino":
        window.open(
          "https://www.spikeslot.com/guida/bonus-benvenuto-casino-com/it"
        );
        break;

      case "LeoVegas Casino":
        window.open(
          "https://www.spikeslot.com/guida/bonus-benvenuto-casino-leovegas/it"
        );
        break;

      case "888 Casino":
        window.open(
          "https://www.spikeslot.com/guida/bonus-benvenuto-888-casino/it"
        );
        break;

      case "Lottomatica":
        window.open(
          "https://www.spikeslot.com/guida/bonus-benvenuto-lottomatica-casino/it"
        );
        break;
      ...
      case "NetBet":
        window.open(
          "https://www.spikeslot.com/guida/netbet-casino-bonus-benvenuto/it"
        );
        break;

      case "Starvegas Casino":
        window.open(
          "https://www.spikeslot.com/guida/bonus-benvenuto-casino-starvegas/it"
        );
        break;

      case "Gioco Digitale Casino":
        window.open(
          "https://www.spikeslot.com/guida/bonus-benvenuto-casino-gioco-digitale/it"
        );
        break;

      case "BetFlag":
        window.open(
          "https://www.spikeslot.com/guida/casino-betflag-bonus-benvenuto/it"
        );
        break;

      case "Bwin":
        window.open(
          "https://www.spikeslot.com/guida/bonus-benvenuto-casino-bwin/it"
        );
        break;

      case "PokerStars Casino":
        window.open(
          "https://www.spikeslot.com/guida/guida-al-bonus-di-benvenuto-pokerstars/it"
        );
        break;

      case "Snai Casino":
        window.open(
          "https://www.spikeslot.com/guida/bonus-benvenuto-casino-snai/it"
        );
        break;

      case "AdmiralYES":
        window.open(
          "https://www.spikeslot.com/guida/bonus-benvenuto-casino-slotyes/it"
        );
        break;

      case "WinCasino":
        window.open(
          "https://spikeslot.com/guida/recensione-wincasino-bonus/it"
        );
        break;
